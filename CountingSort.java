...
public class CountingSort {
	...
	1. キー(配列Aのデータ)を数え上げるための配列Cとソートのための2. 作業用配列Bを用意する
	2. 配列Aのデータの出現頻度を数える(配列Cを利用)
	3. キーの累積度数分布を求める(配列Cが保持)
	4. (配列Cの)累積度数分布に従って配列Aから配列Bにデータをコピーする(必要なら配列Bから元の配列Aにデータをコピーする)
	*/
